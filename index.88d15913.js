 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ce;Ce="",ye(new M("platform-logger",(e=>new he(e)),"PRIVATE")),ye(new M("heartbeat",(e=>new Le(e)),"PRIVATE")),Ee("@firebase/app","0.7.33",Ce),Ee("@firebase/app","0.7.33","esm2017"),Ee("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yn=new Ye(3e4,6e4);function Zn(){const e=yn().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let er=null;function tr(e){return er=er||function(e){return new Promise(((t,n)=>{var r,i,s;function o(){Zn(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Zn(),n(je(e,"network-request-failed"))},timeout:Yn.get()})}if(null===(i=null===(r=yn().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=yn().gapi)||void 0===s?void 0:s.load)){const t=Ln("iframefcb");return yn()[t]=()=>{gapi.load?o():n(je(e,"network-request-failed"))},Tn(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw er=null,e}))}(e),er}
/**
 * @license
 * Copyright 2020 Google LLC.
 *

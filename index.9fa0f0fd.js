 ...
 * limitations under the License.
 */
function(e=ot()){const t=nt(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=nt(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(he(n.getOptions(),null!=t?t:{}))return e;Et(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Jr,persistence:[lr,Kn,Qn]})}(),si=new X,ai=()=>{_r(oi,ii).then((e=>{Mn.credentialFromResult(e).accessToken;const t=e.user;si.userReg(t),si.user=hi(t.email)})).catch((e=>{e.code,e.message,e.customData.email,Mn.credentialFromError(e)}))},ci=()=>{var e;(e=oi,we(e).signOut()).then((()=>{Yr.parentNode.classList.toggle("is-hidden"),Zr.parentNode.classList.toggle("is-hidden")})).catch((()=>{}))};var li,ui,di;function hi(e){return e.split("@")[0].replace(/[^a-zа-яё\s]/gi,"")}li=e=>{console.log("user",e),ri.addEventListener("click",(()=>{null===e&&(ei.classList.remove("visually-hidden"),ni.classList.add("visually-hidden"),ti.classList.add("visually-hidden"))})),null!==e&&(ei.classList.add("visually-hidden"),ti.classList.remove("visually-hidden"),ni.classList.remove("visually-hidden"),si.user=hi(e.email),d.queueBtn.classList.add("library__btn--selected"),d.wached.classList.remove("visually-hidden"),d.queue.classList.remove("visually-hidden"),Qr.innerHTML=hi(e.email),Yr.parentNode.classList.toggle("is-hidden"),Zr.parentNode.classList.toggle("is-hidden"),function(e){d.wached.addEventListener("click",(t=>{if(null==e)return;const n=JSON.parse(document.querySelector(".title_item_info").innerHTML);si.postMovieToLibraryWached(n,hi(e.email))})),d.queue.addEventListener("click",(t=>{if(null==e)return;const n=JSON.parse(document.querySelector(".title_item_info").innerHTML);si.postMovieToLibraryQueue(n,hi(e.email))}))}(e),function(e){d.watchedBtn.addEventListener("click",(t=>{!async function(e){d.watchedBtn.classList.add("library__btn--selected"),d.queueBtn.classList.remove("library__btn--selected"),vi.innerHTML="";Z(await _i.GetUserWached(hi(e.email)))}(e)})),d.queueBtn.addEventListener("click",(t=>{!async function(e){d.watchedBtn.classList.remove("library__btn--selected"),d.queueBtn.classList.add("library__btn--selected"),vi.innerHTML="";Z(await _i.GetUserQueue(hi(e.email)))}(e)}))}(e))},we(oi).onAuthStateChanged(li,ui,di),Yr.addEventListener("click",(()=>{ai()})),Zr.addEventListener("click",(()=>{ci(),Qr.innerHTML=null}));const{watchedBtn:fi,queueBtn:pi,gallerySection__gallery:gi,search:mi,libraryFilter:yi,galleryLibrary:vi,libraryBtn:bi,galleryMain:wi}=d,_i=(new u,new X);const{search:Ei,libraryBtn:ki,homeBtn:Ii,gallery:Si,libraryFilter:Ti,logo:Li,pagEl:Ai,filterContainer:Ri,galleryMain:Ci,galleryLibrary:Oi,gallerySection__gallery:Ni}=d;new u,new X;function xi(){location.reload()}Y(null,"home-bg-img"),ki.addEventListener("click",(function(){Y("home-bg-img","library-bg-img"),"UL"==Ni.childNodes[3].nodeName&&Ni.removeChild(Ci),Ii.addEventListener("click",xi),Ei.classList.add("visually-hidden"),Ti.classList.remove("visually-hidden"),Ii.classList.remove("nav-list__link--selected"),ki.classList.add("nav-list__link--selected"),Ai.classList.add("visually-hidden"),Ri.classList.add("visually-hidden"),Oi.classList.remove("visually-hidden"),Oi.classList.add("library"),d.switchColorCheckbox.parentNode.parentNode.parentNode.classList.add("is-library-open")})),Li.addEventListener("click",xi),Ii.removeEventListener,function(e){const t=e.map((({name:e})=>`<option value="${e}">${e}</option>`)).join("");d.listOfGenres.insertAdjacentHTML("beforeend",t)}(t(h));const Pi=document.querySelector(".btn-to-top");window.addEventListener("scroll",(()=>{window.pageYOffset>document.documentElement.clientHeight/2?Pi.classList.remove("visually-hidden"):Pi.classList.add("visually-hidden")}));var Di={};Di=function e(t,n,r){function i(s,a){if(!n[s]){if(!t[s]){var c=void 0;if(!a&&c)return c(s,!0);if(o)return o(s,!0);var l=new Error("Cannot find module '"+s+"'");throw l.code="MODULE_NOT_FOUND",l}var u=n[s]={exports:{}};t[s][0].call(u.exports,(function(e){return i(t[s][1][e]||e)}),u,u.exports,e,t,n,r)}return n[s].exports}for(var o=void 0,s=0;s<r.length;s++)i(r[s]);return i}({1:[function(e,t,n){Object.defineProperty(n,"__esModule",{value:!0}),n.create=n.visible=void 0;var r=function(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=document.createElement("div");return n.innerHTML=e.trim(),!0===t?n.children:n.firstChild},i=function(e,t){var n=e.children;return 1===n.length&&n[0].tagName===t},o=function(e){return null!=(e=e||document.querySelector(".basicLightbox"))&&!0===e.ownerDocument.body.contains(e)};n.visible=o,n.create=function(e,t){var n=function(e,t){var n=r('\n\t\t<div class="basicLightbox '.concat(t.className,'">\n\t\t\t<div class="basicLightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t')),o=n.querySelector(".basicLightbox__placeholder");e.forEach((function(e){return o.appendChild(e)}));var s=i(o,"IMG"),a=i(o,"VIDEO"),c=i(o,"IFRAME");return!0===s&&n.classList.add("basicLightbox--img"),!0===a&&n.classList.add("basicLightbox--video"),!0===c&&n.classList.add("basicLightbox--iframe"),n}(e=function(e){var t="string"==typeof e,n=e instanceof HTMLElement==1;if(!1===t&&!1===n)throw new Error("Content must be a DOM element/node or string");return!0===t?Array.from(r(e,!0)):"TEMPLATE"===e.tagName?[e.content.cloneNode(!0)]:Array.from(e.children)}(e),t=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(null==(e=Object.assign({},e)).closable&&(e.closable=!0),null==e.className&&(e.className=""),null==e.onShow&&(e.onShow=function(){}),null==e.onClose&&(e.onClose=function(){}),"boolean"!=typeof e.closable)throw new Error("Property `closable` must be a boolean");if("string"!=typeof e.className)throw new Error("Property `className` must be a string");if("function"!=typeof e.onShow)throw new Error("Property `onShow` must be a function");if("function"!=typeof e.onClose)throw new Error("Property `onClose` must be a function");return e}(t)),s=function(e){return!1!==t.onClose(a)&&function(e,t){return e.classList.remove("basicLightbox--visible"),setTimeout((function(){return!1===o(e)||e.parentElement.removeChild(e),t()}),410),!0}(n,(function(){if("function"==typeof e)return e(a)}))};!0===t.closable&&n.addEventListener("click",(function(e){e.target===n&&s()}));var a={element:function(){return n},visible:function(){return o(n)},show:function(e){return!1!==t.onShow(a)&&function(e,t){return document.body.appendChild(e),setTimeout((function(){requestAnimationFrame((function(){return e.classList.add("basicLightbox--visible"),t()}))}),10),!0}(n,(function(){if("function"==typeof e)return e(a)}))},close:s};return a}},{}]},{},[1])(1);new X;const Ui={filmTitle:document.querySelector(".film_title"),largePoster:document.querySelector("source.large"),mediumPoster:document.querySelector("source.medium"),smallPoster:document.querySelector("source.small"),poster:document.querySelector('img[alt="moviesPoster"]'),voteAverage:document.querySelector(".vote_average"),voteCount:document.querySelector(".vote_count"),popularity:document.querySelector(".popularity"),originalTitle:document.querySelector(".original_title"),genres:document.querySelector(".genres"),description:document.querySelector(".description"),toHide:document.querySelector("[data-modal]"),toCloseModal:document.querySelector(".close-btn"),titleInfo:document.querySelector(".title_item_info"),modalWindow:document.querySelector(".backdrop")},Mi=document.querySelector(".close-btn"),Bi=document.querySelector("body");Ui.toCloseModal.addEventListener("click",ji),d.movieList.addEventListener("click",$i),d.galleryLibrary.addEventListener("click",$i);function ji(){Ui.toHide.classList.toggle("is-hidden")}Mi.addEventListener("click",qi);const Fi=new u;function $i(e){qi(),console.log(e.path[3].getAttribute("data-id")),ji();let t=e.path[3].getAttribute("data-id");fetch(`https://api.themoviedb.org/3/movie/${t}$?api_key=e4c439da3c1d90110fb4595b6236c9fe&$&language=en-US`).then((e=>e.json(""))).then((e=>{const n=[];for(const t of e.genres)n.push(t.name);Fi.movieId=t;const r=n.join(),{title:i,vote_average:o,vote_count:s,popularity:a,original_title:c,overview:l,poster_path:u}=e,d={movieID:t,title:i,vote_average:o,vote_count:s,popularity:a,original_title:c,overview:l,poster_path:u,ganreString:r};Ui.titleInfo.innerHTML=JSON.stringify(d),Ui.filmTitle.textContent=i,Ui.voteAverage.textContent=o,Ui.voteCount.textContent=s,Ui.popularity.textContent=a,Ui.originalTitle.textContent=c,Ui.genres.textContent=n,Ui.description.textContent=l,Ui.poster.src=`https://image.tmdb.org/t/p/w300${u}`})).catch((e=>{console.log(e)}))}function qi(){Bi.classList.toggle("no-scroll")}d.openVideoBtn.addEventListener("click",(async function(){const e=(await Fi.fetchOpenMovieByPlayer()).results[0].key,t=Di.create(` <iframe class = "video_frame"\n\n  src="https://www.youtube.com/embed/${e}"\n  title="YouTube video player"\n  frameborder="0"\n  autoplay = "1"\n  allow="accelerometer; allowfullscreen = false; clipboard-write; encrypted-media; gyroscope; picture-in-picture"\n  allowfullscreen\n></iframe>\n      </br>\n      <button type="button" class="videoBtnClose  is-hidden">Close Trailer</i></button>\n    `,{onShow:e=>(e.element().querySelector(".videoBtnClose").onclick=e.close,e)});t.show(),window.addEventListener("keydown",(function e(n){"Escape"===n.code&&(t.close(),window.addEventListener("keydown",e))}));const n=document.querySelector(".videoBtnClose");setTimeout((()=>{n.classList.remove("is-hidden")}),1e4)})),document.addEventListener("keydown",(e=>{Ui.modalWindow.classList.contains("is-hidden")||Ui.modalWindow.classList.add("is-hidden")}));new URL(o("kyEFX").resolve("dq01P"),import.meta.url).toString();var Hi;Hi=new URL(o("kyEFX").resolve("lp5u4"),import.meta.url).toString();var zi;zi=new URL(o("kyEFX").resolve("6MBUB"),import.meta.url).toString();var Vi;Vi=new URL(o("kyEFX").resolve("kU3G8"),import.meta.url).toString();var Wi;Wi=new URL(o("kyEFX").resolve("1JG3z"),import.meta.url).toString();var Gi;Gi=new URL(o("kyEFX").resolve("9XAjB"),import.meta.url).toString();var Ji;Ji=new URL(o("kyEFX").resolve("k4cek"),import.meta.url).toString();var Ki;Ki=new URL(o("kyEFX").resolve("8uwgR"),import.meta.url).toString();var Xi;Xi=new URL(o("kyEFX").resolve("2j2H3"),import.meta.url).toString();var Qi;Qi=new URL(o("kyEFX").resolve("8gcFo"),import.meta.url).toString();var Yi;Yi=new URL(o("kyEFX").resolve("bmoUh"),import.meta.url).toString();var Zi;Zi=new URL(o("kyEFX").resolve("ineFI"),import.meta.url).toString();var eo;eo=new URL(o("kyEFX").resolve("6zkT4"),import.meta.url).toString();const to=[{name:"Maksym",image:t(zi),github:"https://github.com/makfiz",id:1,position:"Team Lead"},{name:"Kateryna",image:t(Vi),github:"https://github.com/Ekaterina-Kazantseva",id:2,position:"Scrum Master"},{name:"Andrii",image:t(Wi),github:"https://github.com/syniuk-a",id:3,position:"Developer"},{name:"Anton",image:t(Gi),github:"https://github.com/Ex0rc1st",id:4,position:"Developer"},{name:"Alina",image:t(eo),github:"https://github.com/Alialinaa19",id:5,position:"Developer"},{name:"Ilya",image:t(Ji),github:"https://github.com/illia-RD",id:6,position:"Developer"},{name:"Volodymyr",image:t(Ki),github:"https://github.com/Aleks-corp",id:7,position:"Developer"},{name:"Aleksandr",image:t(Yi),github:"link",id:8,position:"Developer"},{name:"Yurii",image:t(Xi),github:"link",id:9,position:"Developer"},{name:"Natalya",image:t(Zi),github:"link",id:10,position:"Developer"},{name:"George",image:t(Qi),github:"https://github.com/WrWl",id:11,position:"Developer"}];document.querySelector(".team-modal").addEventListener("click",(function(e){ro.show(),window.addEventListener("keydown",(function e(t){"Escape"===t.code&&(ro.close(),window.removeEventListener("keydown",e))}))}));const no=`\n<div class="team-list">\n${to.map((e=>`<div class="team-card">\n         <img src="${e.image}" alt="Maksym" class="team-image">\n         <p class="team-name">${e.name}</p>\n         <p class="team-role">${e.position}</p>\n         <a href="${e.github}" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">\n           <use href="${t(Hi)}#github"></use>\n         </svg></a>\n     </div>`)).join("")}\n</div>`,ro=Di.create(no);
//# sourceMappingURL=index.9fa0f0fd.js.map

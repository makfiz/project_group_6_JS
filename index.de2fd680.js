 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var dt;dt="",Qe(new ve("platform-logger",(e=>new We(e)),"PRIVATE")),Qe(new ve("heartbeat",(e=>new ct(e)),"PRIVATE")),rt("@firebase/app","0.7.33",dt),rt("@firebase/app","0.7.33","esm2017"),rt("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wt(e){return 1e3*Number(e)}function Gt(e){var t;const[n,r,i]=e.split(".");if(void 0===n||void 0===r||void 0===i)return vt("JWT malformed, contained fewer than 3 sections"),null;try{const e=ee(r);return e?JSON.parse(e):(vt("Failed to decode base64 JWT payload"),null)}catch(e){return vt("Caught error parsing JWT payload as JSON",null===(t=e)||void 0===t?void 0:t.toString()),null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function yn(e,t=[]){let n;switch(e){case"Browser":n=on(ne());break;case"Worker":n=`${on(ne())}-${e}`;break;default:n=e}return`${n}/JsCore/9.10.0/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
